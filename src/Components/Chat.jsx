...
function Chat({ chat, onVolver }) {
    ...
    const mensajesPorChat = {
        1: [
            {
                id: 1,
                texto: "Che, ¿al final pudiste descargar el programa ese?",
                hora: "08:12",
                tipo: "received"
            },
            {
                id: 2,
                texto: "Todavía no, me va re lento.",
                hora: "08:15",
                tipo: "sent"
            },
            {
                id: 3,
                texto: "Uy, bajá algo más liviano entonces.",
                hora: "08:18",
                tipo: "received"
            }
        ],
        2: [
            {
                id: 1,
                texto: "Avisame cuando estés por salir así te espero abajo.",
                hora: "10:40",
                tipo: "received"
            },
            {
                id: 2,
                texto: "Apurate que hace frío jaja",
                hora: "10:42",
                tipo: "received"
            },
            {
            ...
            {
                id: 5,
                texto: "Estoy en la puerta, te espero!",
                hora: "10:48",
                tipo: "received"
            }
        ],
        3: [
            {
                id: 1,
                texto: "No sabés el frío que hace acá, traete una campera.",
                hora: "13:20",
                tipo: "received"
            },
            {
                id: 2,
                texto: "Menos mal que me avisaste!",
                hora: "13:25",
                tipo: "sent"
            },
            {
                id: 3,
                texto: "En serio, está helado hoy",
                hora: "13:28",
                tipo: "received"
            },
            {
                id: 4,
                texto: "Capaz llueve también, fijate el clima",
                hora: "13:29",
                tipo: "received"
            }
        ],
        4: [
            {
                id: 1,
                texto: "Te mandé una foto de lo que compramos, ¿te gusta?",
                hora: "16:10",
                tipo: "received"
            },
            {
                id: 2,
                texto: "¡Está buenísima!",
                hora: "16:15",
                tipo: "sent"
            }
        ],
        5: [
            {
                id: 1,
                texto: "¡Feliz cumple loco! Espero que la pases de diez.",
                hora: "19:55",
                tipo: "received"
            },
            {
            ...
            {
                id: 3,
                texto: "¿Cómo la estás pasando?",
                hora: "20:05",
                tipo: "received"
            },
            {
                id: 4,
                texto: "Re bien, con la familia!",
                hora: "20:08",
                tipo: "sent"
            },
            {
                id: 5,
                texto: "Qué bueno! Saludos a todos 🎉",
                hora: "20:10",
                tipo: "received"
            }
        ]
